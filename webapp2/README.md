# TODO
- реистрация скрыть поля для физиков
- капча
- дизайн ЕТП
- обязательность полей при заполнении КП и вывод ошибок в снэкмессадж
- вывод ошибок запросов в аппе в снекмессадж
- Скачивание ТЗ
- Прикрепление и Отправка КП
- Скрыть кнопку редактированя КП на странице редактирования
...
- дата сохранения КП - нет переменной 
