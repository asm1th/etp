        ...
        <>
            ...
            <Layout className="mb1">
                ...
                <Layout flex={10} className="SubSummFooter">
                    ...
                    <Layout flex={3} className="aic jcc">{parseFloat(cost_sums.cost_other.sum_full_price) == 0 ? "-- --" : numberWithSpaces(cost_sums.cost_other.sum_full_price)}</Layout>
                    <Layout flex={3} className="aic jcc">{parseFloat(cost_sums.cost_other.sum_user_per_month) == 0 ? "-- --" : numberWithSpaces(cost_sums.cost_other.sum_user_per_month)}</Layout>
                    <Layout flex={3} className="aic jcc">{parseFloat(cost_sums.cost_other.sum_price_per_user_per_month) == 0 ? "-- --" : numberWithSpaces(cost_sums.cost_other.sum_price_per_user_per_month)}</Layout>
